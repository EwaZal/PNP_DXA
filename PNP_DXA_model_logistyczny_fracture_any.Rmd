...
BIC(modelPHPT1)
BIC(modelPHPT, modelPHPT1)
```

## Z jakimi cechami wiązało się występowanie zlamań w grupie badanej w modelu logistycznym? - JEDNAK TEN WBRANY BO AIC 129.3 (niższy)
``` {r}
...
BIC(modelPHPT2)
BIC(modelPHPT, modelPHPT1, modelPHPT2)
```
...
BIC(modelPHPT3)
BIC(modelPHPT, modelPHPT1, modelPHPT2, modelPHPT3)
```
